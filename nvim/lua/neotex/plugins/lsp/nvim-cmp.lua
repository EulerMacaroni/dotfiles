return {
	{
		...
		config = function()
			...
			-- find more here: https://www.nerdfonts.com/cheat-sheet
				...
				-- consolidated below: single cmp.setup call
	...
	{ --- plugin for copilot integration. (github.com/github/copilot.vim)
		"github/copilot.vim",
		config = function()
			-- Do not map <Tab>; keep your cmp/snippet flow intact
			vim.g.copilot_no_tab_map = true
			-- Do not start suggestions automatically; enable with :Copilot enable
			vim.g.copilot_enabled = false
			-- Use Right Arrow to accept suggestions; fallback to normal Right when none
